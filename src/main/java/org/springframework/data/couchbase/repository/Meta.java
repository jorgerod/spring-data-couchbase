...
public @interface Meta {
  ...
  /**
   * Set {@link org.springframework.data.couchbase.core.query.Meta.CursorOption} to be used when executing query.
   *
   * @return never {@literal null}.
   * @since 1.10
   */
  org.springframework.data.couchbase.core.query.Meta.CursorOption[] flags() default {};
